...
// */
//
//public class PropertyTypeView extends LinearLayout implements View.OnClickListener {
//
//
//    private YesNoAllSwitchViewBinding mBinding;
//
//
//    public PropertyTypeView(Context context, @Nullable AttributeSet attrs) {
//        super(context, attrs);
//        initUi(context, attrs);
//    }
//
//
//    public PropertyTypeView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
