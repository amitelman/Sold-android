...
public class ListViewEnhance {
     ...
     * @return
     */
    public static boolean needListScale(ListViewExt listView, int offset , LinearLayout linearLayout , int initalChangeableHeight) {
        ...
        setHeightOfLinear(linearLayout,initalChangeableHeight+offset);
    ...
    private static void setHeightOfLinear(LinearLayout linearLayout, int height){
    ...
    private static void setHeightOfLinearWithAnimatin( LinearLayout linearLayout){
        if(linearLayout!=null){
            RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) linearLayout.getLayoutParams();
            ObjectAnimator alpha = ObjectAnimator.ofFloat(linearLayout,"height", 0.25f, 1f);
...
//            linearLayout.requestLayout();
    ...
    public static void onRenderTick(ListViewExt listView, Canvas canvas, LinearLayout linearLayout, int initalChangeableHeight) {

        if (listView.mAnimatorSet != null && listView.mAnimatorSet.isRunning()) {
            Log.d("overScroll", "Phase 1");
//            setHeightOfLinear(linearLayout, (int) (initalChangeableHeight * listView.getScaleY()));
//            setPaddingOfListView(listView, (int) (initalChangeableHeight * listView.getScaleY()));
//            setListScale(listView, canvas, 0, false);
        } else if (listView.mIsTouching) {
            if (listView.mScaleYDirty || listView.getScaleY() != 1) {
                Log.d("overScroll", "Phase 2");
//                setHeightOfLinear(linearLayout, (int) (linearLayout.getHeight() * 0.7f));
//                setPaddingOfListView(listView, (int) (linearLayout.getHeight() * 0.7f));
//                setListScale(listView, canvas, listView.mInertia, false);
            ...
            Log.d("overScroll", "Phase 3");
            setListScale(listView, canvas, listView.mInertia, true);
//            setPaddingOfListView(listView, (int) (linearLayout.getHeight()*0.7f));
            listView.mInertia = 0;
        } else {
            Log.d("overScroll", "Phase 4");
//            listView.mInertia = (int) (listView.mInertia * 0.98f);
//            setHeightOfLinear(linearLayout, (int) (linearLayout.getHeight()*0.7f));
//            setPaddingOfListView(listView, 0);
            if (listView.mInertia == 0) {
                Log.d("overScroll", "Phase 5");
//                listView.setScaleY(1);
//                setHeightOfLinear(linearLayout, initalChangeableHeight);
//                setPaddingOfListView(listView, initalChangeableHeight);
               // setHeightOfLinearWithAnimatin(linearLayout);
            }
        }
    }

    private static void setPaddingOfListView(ListViewExt listView,int initalChangeableHeight) {
        if(initalChangeableHeight >0)
            listView.setPadding(0, initalChangeableHeight, 0, 0);
    }
