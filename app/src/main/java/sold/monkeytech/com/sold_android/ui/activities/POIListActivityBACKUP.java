...
//
//public class POIListActivityBACKUP extends BaseActivity implements SearchInMapFragment.OnMapFragmentListener {
//
...
//        mBinding = DataBindingUtil.setContentView(this, R.layout.activity_poilist_backup);
//
...
//                map = googleMap;
//                if (ContextCompat.checkSelfPermission(POIListActivityBACKUP.this, Manifest.permission.ACCESS_FINE_LOCATION)
...
//                    PermissionUtils.askPermissions(POIListActivityBACKUP.this, PermissionUtils.LOCATION_PERMISSIONS_1, PermissionUtils.PERMISSION_LOCATION_1_REQUEST_CODE, getString(R.string.perm_location_rationale));
//                }
//
